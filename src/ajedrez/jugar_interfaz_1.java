 ...
 * @author AlexGis
 */
public class jugar_interfaz_1 extends javax.swing.JFrame {
    ...
    public Usuario getUsuario(){
        for(Usuario u : users_menu){
            System.out.println(u.getnombre()+"     "+jLabel11.getText());
            if(u.getnombre().equals(this.jLabel11.getText()))
                usuario_menu=u;
        }
        return usuario_menu;
    }
   ...
   //ATRAS
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        this.getUsuario();
        menu.jLabel6.setText(this.jLabel11.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try(ObjectInputStream ob=new ObjectInputStream(new FileInputStream("Almacenproblemas.bin"))){
            while(true){
                almacen_problemas aux=(almacen_problemas) ob.readObject();
                    if(aux.getid()==Integer.parseInt(this.jLabel10.getText())){
                        sol=aux.getsol();
        ...
        if(sol[0].equals(jTextField1.getText())){
